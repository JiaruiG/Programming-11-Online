public class Main {
    public static void main(String args[]){
        ...
        System.out.println((7 + 3) * Math.sin(Math.toRadians(45)) + 2 - Math.pow(Math.sqrt(25), 3));
        System.out.println(10 * Math.sin(Math.toRadians(45)) + 2 - Math.pow(Math.sqrt(25), 3));
        System.out.println(10 * 0.70710678118 + 2 - Math.pow(Math.sqrt(25), 3));
        System.out.println(7.0710678118 + 2 - Math.pow(Math.sqrt(25), 3));
        System.out.println(7.0710678118 + 2 - Math.pow(5.0, 3));
        System.out.println(7.0710678118 + 2 - 125.0);
        System.out.println(9.0710678118 - 125.0);
        System.out.println(-115.9289321882);
    }
}
